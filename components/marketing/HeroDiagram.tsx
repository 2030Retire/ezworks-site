    ...
    <div className="rounded-2xl border border-line bg-surface p-3 shadow-[0_1px_2px_rgba(22,32,43,0.04),0_12px_32px_-12px_rgba(22,32,43,0.12)] sm:p-4">
      <div className="rounded-xl border border-line bg-white p-3.5 sm:p-4">
        ...
        <div className="rounded-lg border border-line bg-white p-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="truncate text-[13px] font-semibold text-ink">Photo taken at the counter</p>
              <p className="truncate font-mono text-[11.5px] text-soft">receipt-0814.jpg</p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-line bg-white p-3">
          <div className="mb-1.5 flex items-center justify-between gap-2">
            <p className="text-[13px] font-semibold text-ink">Read automatically</p>
            <Chip tone="brand">no typing</Chip>
          </div>
          <Row label="Vendor" value="Northline Supply" />
          <Row label="Date" value="Aug 14, 2026" />
          <Row label="Total" value="$248.60" mono />
          <Row label="Category" value="Job materials" />
        </div>
        ...
        <div className="rounded-lg border border-line bg-white p-3">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <p className="text-[13px] font-semibold text-ink">Approved by rule, posted to the books</p>
            <Chip tone="done">
          ...
          <p className="mt-1.5 text-[12px] leading-relaxed text-soft">
            Under the limit for its category, so it routed to one approver and
      ...
      <div className="mt-3 rounded-xl border border-line bg-white p-3.5 sm:p-4">
        <div className="flex items-center gap-2.5">
          ...
          <p className="min-w-0 flex-1 truncate font-mono text-[11.5px] text-soft">2026-08-14 Team sync.md</p>
        </div>
        <ul className="mt-2.5 space-y-1 text-[12.5px] leading-relaxed text-ink">
          <li className="flex gap-2"><span aria-hidden="true" className="mt-[7px] h-1 w-1 shrink-0 rounded-full bg-brand" />Decision: pilot the new intake form in September</li>
          <li className="flex gap-2"><span aria-hidden="true" className="mt-[7px] h-1 w-1 shrink-0 rounded-full bg-brand" />Action: send the vendor list by Friday</li>
        </ul>
